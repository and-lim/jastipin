        ...
        <div class="col-lg-12">
            ...
            <div class="card p-3">
                ...
                @endphp
                    ...
                    <div class="item-cart card p-3 border-bottom border-2 border-dark my-1">
                        <p class="text-start fw-bold text-primary">{{ $trip->destination }} - {{ $trip->origin }}</p>
                        <div class="row gap-3">
                            <div class="col-lg-3">
                                <img src="{{ asset('/storage/' .$item->item_image) }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-8">
                                <div class="item-desc pb-2">
                ...
                @endphp
                    ...
                    <div class="item-cart border-bottom border-2 border-dark my-1">
                        <div class="row gap-3 my-2">
                            <h3 class="text-start">Request</h3>
                            <div class="col-lg-3">
                                <img src="{{ asset('/storage/' .$request->request_image) }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-8">
                                <div class="request-item">
                                    <a href="/trip-detail/{{ $request->trip_id }}" class="text-decoration-none text-dark">
